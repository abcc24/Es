...
#5.5 Turn your if-else chain from Exercise 5-4 into an if-elif-else chain.
...
names=["admin","jacob","jamal","andrew","rick"]
for name in names:
        if name == "admin":
...
current_users=["jacob","marco","xplayer","antony","kevin"]
new_users=["dwayne","mike","donald","george","jeffrey"]
...
#5.11 Ordinal numbers indicate their position in a list, such as 1st or 2nd. 
